...
export const Contact = () => {
  ...
  return (
    <section id="contact" className="min-h-screen flex items-center justify-center py-12 md:py-20 px-4 sm:px-6">
      <RevealOnScroll>
        <div className="w-full max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl p-6 md:p-8 lg:p-10 bg-white/5 backdrop-blur-sm rounded-xl border border-gray-200/10 hover:border-blue-500/20 transition-all duration-300">
          ...
          <form className="space-y-4 sm:space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              ...
              className={`w-full bg-gradient-to-r from-blue-500 to-cyan-500 text-white py-3 px-6 rounded-lg font-medium transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/20 flex items-center justify-center ${
